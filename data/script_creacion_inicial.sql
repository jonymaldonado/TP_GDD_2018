...
BEGIN TRANSACTION
	INSERT INTO EL_GROUP_BY.FUNCIONALIDAD VALUES ('ABM_ROL')
	INSERT INTO EL_GROUP_BY.FUNCIONALIDAD VALUES ('ABM_CLIENTE')
	INSERT INTO EL_GROUP_BY.FUNCIONALIDAD VALUES ('ABM_EMPRESA')
	INSERT INTO EL_GROUP_BY.FUNCIONALIDAD VALUES ('ABM_RUBRO')
	INSERT INTO EL_GROUP_BY.FUNCIONALIDAD VALUES ('ABM_GRADO_PUBLICACION')
	INSERT INTO EL_GROUP_BY.FUNCIONALIDAD VALUES ('GENERAR_PUBLICACION')
	INSERT INTO EL_GROUP_BY.FUNCIONALIDAD VALUES ('EDITAR_PUBLICACION')
	INSERT INTO EL_GROUP_BY.FUNCIONALIDAD VALUES ('COMPRAR')
	INSERT INTO EL_GROUP_BY.FUNCIONALIDAD VALUES ('HISTORIAL_CLIENTE')
	INSERT INTO EL_GROUP_BY.FUNCIONALIDAD VALUES ('CANJE_ADMINISTRACION_PUNTOS')
	INSERT INTO EL_GROUP_BY.FUNCIONALIDAD VALUES ('GENERAR_PAGO_COMISIONES')
	INSERT INTO EL_GROUP_BY.FUNCIONALIDAD VALUES ('LISTADO_ESTADISTICO')
	INSERT INTO EL_GROUP_BY.FUNCIONALIDAD VALUES ('ADMINISTRACION_USUARIOS')
	INSERT INTO EL_GROUP_BY.FUNCIONALIDAD VALUES ('CAMBIAR_PASSWORD')
COMMIT;
GO
...
BEGIN TRANSACTION
	...
	INSERT INTO EL_GROUP_BY.Grado_Publicacion VALUES (0,'BAJA',10,1)
	INSERT INTO EL_GROUP_BY.Grado_Publicacion VALUES (0,'MEDIA',20,1)
	INSERT INTO EL_GROUP_BY.Grado_Publicacion VALUES (0,'ALTA',30,1)
COMMIT;
GO	
-- -----------------------------------------------------
...
as
begin
	select count(USUARIO_ID) from EL_GROUP_BY.ROL_USUARIO where USUARIO_ID = @USU_ID 
end
go
...
begin
	select F.Funcionalidad_ID from EL_GROUP_BY.FUNCIONALIDAD F inner join EL_GROUP_BY.ROL_FUNCIONALIDAD RXU 
		on F.Funcionalidad_ID = RXU.Funcionalidad_ID where RXU.Rol_ID = @ROL_ID 
end
go
...
begin
	...
	begin
		insert into EL_GROUP_BY.Rol_Usuario values (@USER_ID, @ROL_ID)
	end
end
go
